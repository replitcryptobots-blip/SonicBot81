...
export class Dex2Adapter {
  constructor(provider) {
    this.provider = provider;
    this.name = config.dex2.name;
    this.routerAddress = config.dex2.router;
    this.factoryAddress = config.dex2.factory;
    this.feeBps = config.dex2.feeBps;
